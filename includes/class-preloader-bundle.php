<?php
/**
 * This file contains the definition of the Preloader_Bundle class, which
...
class Preloader_Bundle {
	 ...
	 * @since     2.0.0
	 * @access    protected
	 * @var       Preloader_Bundle_Loader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		$this->version     = defined( 'PRELOADER_BUNDLE_PLUGIN_VERSION' ) ? PRELOADER_BUNDLE_PLUGIN_VERSION : '1.0.0';
		$this->plugin_name = 'preloader-bundle';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once PRELOADER_BUNDLE_PLUGIN_PATH . 'includes/class-preloader-bundle-loader.php';
		 ...
		 */
		require_once PRELOADER_BUNDLE_PLUGIN_PATH . 'admin/class-preloader-bundle-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once PRELOADER_BUNDLE_PLUGIN_PATH . 'public/class-preloader-bundle-public.php';

		$this->loader = new Preloader_Bundle_Loader();
	}

	/**
	 * Define the locale for this plugin for internationalization.
	 *
	 * Uses the Preloader_Bundle_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since     2.0.0
	 * @access    private
	...
	private function set_locale() {
		$plugin_i18n = new Preloader_Bundle_i18n();
	...
	private function define_admin_hooks() {
		$plugin_admin = new Preloader_Bundle_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );

		$this->loader->add_action( 'plugin_action_links_' . PRELOADER_BUNDLE_PLUGIN_BASENAME, $plugin_admin, 'add_plugin_action_links' );
	...
	private function define_public_hooks() {
		$plugin_public = new Preloader_Bundle_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 * @since     2.0.0
	 * @access    public
	 * @return    Preloader_Bundle_Loader Orchestrates the hooks of the plugin.
	 */
